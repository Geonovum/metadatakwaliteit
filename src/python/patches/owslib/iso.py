...
#           Thijs Brentjens (thijs@brentjensgeoict.nl) -- for some fixes / changes for Geonovum
#
...
class MD_DataIdentification(object):
    ...
    def __init__(self, md, identtype):
        ...
        val = md.find(util.nspath_eval('gmd:citation/gmd:CI_Citation/gmd:identifier/gmd:MD_Identifier/gmd:code/gco:CharacterString', namespaces))        
        self.md_identifier = util.testXMLValue(val)
