...
def http_post(url=None, request=None, lang='en-US', timeout=10, username=None, password=None, cookies=None):
    """
    ...
    - cookies: cookies,if needed (Added by Thijs Brentjens, for geonovum)
